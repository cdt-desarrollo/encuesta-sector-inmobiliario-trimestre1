...
function sendData(array) {
    ...
    var config = {
      method: "post",
      url: "https://sheet.best/api/sheets/32aacf91-902e-4e88-8d70-e596b2f41ceb/tabs/trim12023",
      mode: "cors",
      headers: {
  ...
  Swal.fire({
    ...
    preConfirm: () => {
      ...
      if(ciudad == ""){
        ...
        if (inputObject.id == "otrostrim1q11") {
          document.getElementById("insertCitytrim1q11").innerHTML = "";
          document.getElementById("otrostrim1q11").value = ciudad;
  ...
  Swal.fire({
    ...
    preConfirm: () => {
      ...
      if(uso == ""){
        ...
        if(inputObject.id == "otrostrim1q15"){
          document.getElementById("insertUsetrim1q15").innerHTML = "";
          document.getElementById("otrostrim1q15").value = uso;
          document.getElementById(
            "insertUsetrim1q15"
